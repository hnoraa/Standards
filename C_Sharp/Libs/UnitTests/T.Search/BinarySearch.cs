...
namespace T.Search
{
    ...
    public class BinarySearch
    {
        ...
        public void SearchFirst()
        {
            array.BubbleSort();
            int? search;
            search = array.BinarySearch(searchFirst, 0, length);
        ...
        public void SearchLast()
        {
            array.BubbleSort();
            int? search;
            search = array.BinarySearch(searchLast, 0, length);
        ...
        public void SearchMiddle()
        {
            array.BubbleSort();
            int? search;
            search = array.BinarySearch(searchMiddle, 0, length);
        ...
        public void SearchNotFound()
        {
            array.BubbleSort();
            int? search;
            search = array.BinarySearch(searchNotFound, 0, length);
        ...
        public void SearchDuplicate()
        {
            array.BubbleSort();
            int? search;
            search = array.BinarySearch(searchDuplicate, 0, length);
